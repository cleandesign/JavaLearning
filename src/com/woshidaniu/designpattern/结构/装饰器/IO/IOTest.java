package com.woshidaniu.designpattern.结构.装饰器.IO;
...
public class IOTest {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        //文件路径可自行更换
        final String filePath = "/Users/kang/Project/JavaLearning/src/com/woshidaniu/designpattern/结构/装饰器/IO/test.txt";
